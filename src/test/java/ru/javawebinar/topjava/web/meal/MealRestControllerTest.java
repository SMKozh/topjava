...
class MealRestControllerTest extends AbstractControllerTest {
    ...
    void delete() throws Exception {
        perform(MockMvcRequestBuilders.delete(REST_URL + MealTestData.MEAL1_ID))
                ...
                .andDo(print());
        assertThrows(NotFoundException.class, () -> mealService.get(MealTestData.MEAL1_ID, USER_ID));
    }
    ...
    void getBetween() throws Exception {
        perform(MockMvcRequestBuilders.get(REST_URL + "between?startDate=&startTime=10:00:00&endDate=2020-01-30&endTime=20:00:00"))
                .andExpect(status().isOk())
                .andDo(print())
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
